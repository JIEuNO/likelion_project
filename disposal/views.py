...
def create2(request):
    disposal=Disposal()
    disposal.title=request.GET['title']
    disposal.name=request.GET['name']
    disposal.item=request.GET['item']
    disposal.address=request.GET['address']
    disposal.phone=request.GET['phone']
    disposal.etc=request.GET['etc']
